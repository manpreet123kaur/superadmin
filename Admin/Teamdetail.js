    ...
    return (
        <ScrollView>
            <View style={{ width: '95%', flexDirection: 'row', alignItems: 'center', alignSelf: 'center', paddingTop: 20 }}>
                <TouchableOpacity style={{ width: '5%' }} onPress={() => navigation.navigate("Adrawernavigation")}>
            ...
            <View style={{ alignSelf: 'center', padding: 15, width: '90%' }}>
                ...
                <>
                    <View>
                        <TouchableOpacity style={{ flexDirection: "row", alignItems: 'center', width: '100%', padding: 10, borderWidth: 1, borderRadius: 8, borderColor: 'lightgrey', marginTop: 8 }} onPress={() => navigation.navigate("Usersprofileforproject")}>
                            <View style={{ width: '20%' }}>
