...
const Usersprofileforproject = ({ navigation }) => {
        ...
        <ScrollView>
            <View style={{ backgroundColor: 'white' }}>
                <View style={{ alignSelf: 'center', width: '100%' }}>
                    <TouchableOpacity style={{ paddingLeft: 20, marginTop: 35 }} onPress={() => navigation.navigate("Teamdetail")}>
...
export default Usersprofileforproject;