...
const Teammanage = ({ navigation }) => {
    ...
    return (
        <View style={{ backgroundColor: 'white' }}>
            <TouchableOpacity style={{ width: '90%', alignSelf: 'center', borderRadius: 10, padding: 20, borderWidth: 1, borderColor: 'lightgrey', borderBottomWidth: 3, marginBottom: 10, marginTop: 30 }} onPress={() => navigation.navigate("Teamdetail")}>
            ...
            <TouchableOpacity style={{ width: '90%', alignSelf: 'center', borderRadius: 10, padding: 20, borderWidth: 1, borderColor: 'lightgrey', borderBottomWidth: 3, marginBottom: 10 }} onPress={() => navigation.navigate("Teamdetail")}>
