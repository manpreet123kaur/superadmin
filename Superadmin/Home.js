        ...
        <>
            <ScrollView>
                <View style={{ justifyContent: 'center', padding: 15, backgroundColor: 'white' }}>
                    ...
                    <View style={{ marginTop: 20, width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ backgroundColor: '#e1e6f7', padding: 15, borderRadius: 10, elevation: 10, shadowColor: 'black', margin: 10, width: '45%' }}>
                            <Text style={{ fontSize: 17, paddingLeft: 4, fontFamily: 'mainFont' }}>All Admin</Text>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ fontSize: 12, padding: 4, width: '80%', fontFamily: 'mainFont' }}>2</Text>
                                <View style={{ backgroundColor: '#233CBF', borderRadius: 10, padding: 6 }}>
                                    <FontAwesomeIcon size={12} color='white' icon={faUsers} />
                                </View>
                            </View>
                        </View>

                        <View style={{ backgroundColor: '#e1e6f7', padding: 15, borderRadius: 10, elevation: 10, shadowColor: 'black', margin: 10, width: '45%' }}>
                            <Text style={{ fontSize: 17, paddingLeft: 4, fontFamily: 'mainFont' }}>Active Admin</Text>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ fontSize: 12, padding: 4, width: '80%', fontFamily: 'mainFont' }}>2</Text>
                                <View style={{ backgroundColor: '#233CBF', borderRadius: 10, padding: 6 }}>
                                    <FontAwesomeIcon size={12} color='white' icon={faUsers} />
                    ...
                    <View style={{ marginTop: 0, width: '100%', flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ backgroundColor: '#e1e6f7', padding: 15, borderRadius: 10, elevation: 10, shadowColor: 'black', margin: 10, width: '45%' }}>
                            <Text style={{ fontSize: 17, paddingLeft: 4, fontFamily: 'mainFont' }}>Inactive Admin</Text>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ fontSize: 12, padding: 4, width: '80%', fontFamily: 'mainFont' }}>2</Text>
                                <View style={{ backgroundColor: '#233CBF', borderRadius: 10, padding: 6 }}>
                                    <FontAwesomeIcon size={12} color='white' icon={faUsers} />
                        ...
                        <View style={{ backgroundColor: '#e1e6f7', padding: 15, borderRadius: 10, elevation: 10, shadowColor: 'black', margin: 10, width: '45%' }}>
                            <Text style={{ fontSize: 17, paddingLeft: 4, fontFamily: 'mainFont' }}>Visitors</Text>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ fontSize: 12, padding: 4, width: '80%', fontFamily: 'mainFont' }}>223</Text>
                                <View style={{ backgroundColor: '#233CBF', borderRadius: 10, padding: 6 }}>
                                    <FontAwesomeIcon size={12} color='white' icon={faUsers} />
                                </View>
                            </View>
                ...
                <View style={{ backgroundColor: 'white', paddingBottom: 30 }}>
                    <View style={{ width: '98%', alignSelf: 'center', marginTop: 20, borderRadius: 10, padding: 15 }}>
                        <Text style={{ fontFamily: 'mainFont', fontSize: 20 }}>List of Admins</Text>
                    </View>
