        ...
        <ScrollView>
            <View style={{ width: '98%', alignSelf: 'center', height: '100%', backgroundColor: "white" }}>
                ...
                <View style={{ alignSelf: 'center' }}>
                    <Text style={{ color: 'black', fontWeight: '500', fontSize: 15, fontFamily: 'mainFont', textAlign: 'center' }}>Graphic Designer</Text>
                    ...
                    <View style={{ width: '95%', alignSelf: 'center', padding: 15, borderRadius: 12, margin: 0, paddingTop: 0 }}>
                        <View style={{ width: '100%' }}>
                            ...
                            <View style={{ padding: 10 }}>
                                <TextInput style={{ fontSize: 14, color: 'grey' }} placeholder='Graphic Designer' />
                            </View>
                        </View>
                        <View style={{ width: '100%' }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
