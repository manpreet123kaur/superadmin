...
const Performancefortl = ({ navigation }) => {
            ...
            <View style={{ backgroundColor: 'white', height: 1000 }}>
                <View>
                    <View style={{ flexDirection: 'row', paddingTop: 20, width: '95%', alignSelf: 'center' }}>
                        <TouchableOpacity style={{ paddingLeft: 20, marginTop: 20 }} onPress={() => navigation.navigate("DrawernavigationT")}>
                ...
                <Progress.Pie progress={0.4} size={75} />
...
export default Performancefortl;